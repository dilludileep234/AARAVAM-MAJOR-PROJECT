...
<head>
    ...
    <title>Credentials Recovery | Aaravam</title>
...
<body class="min-h-screen flex items-center justify-center p-6 relative">
    ...
    <div class="w-full max-w-[440px] relative z-10">
        ...
        <div class="glass-terminal rounded-[2.5rem] p-10 relative overflow-hidden">
            ...
            <div class="mb-8">
                <a href="{{ route('admin') }}" class="inline-flex items-center gap-2 text-[10px] font-black text-blue-500 uppercase tracking-widest hover:text-blue-400 transition mb-4">
                    <i class="fas fa-arrow-left"></i>
                    <span>Back to Terminal</span>
                </a>
                <h2 class="text-2xl font-black text-white tracking-tight">Credentials Recovery</h2>
                <p class="text-slate-400 text-sm mt-1">Request an encrypted access token via email.</p>
            </div>
            ...
            <form action="{{ route('admin.forgot-password.post') }}" method="POST" class="space-y-6">
                @csrf
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-[2px] px-1">Registered Email</label>
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-black py-4 rounded-2xl transition-all shadow-xl shadow-blue-900/40 active:scale-[0.98] uppercase text-xs tracking-[2px] flex items-center justify-center gap-3">
                        <span>Dispatch Access Token</span>
        ...
        <div class="mt-8 text-center">
            <p class="text-slate-800 text-[9px] font-bold uppercase tracking-[1px]">
                Upon verification, a secure link will be dispatched to your clearance-approved email address.
            </p>
        </div>
    </div>
</body>
