...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-3xl font-bold text-white">Edit Calendar Event</h1>
    </div>
    ...
    <form action="{{ route('admin.academic-calendar.update', $event) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="glass-card p-8 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="type" required 
                        ...
                        <option value="event" {{ old('type', $event->type) == 'event' ? 'selected' : '' }}>General Event</option>
                        <option value="exam" {{ old('type', $event->type) == 'exam' ? 'selected' : '' }}>Examination</option>
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="4" 
                          class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-indigo-500 transition"
                          placeholder="Provide more details about the event...">{{ old('description', $event->description) }}</textarea>
            </div>
        </div>
